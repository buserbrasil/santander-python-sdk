...
from santander_client.api_client import get_client, SantanderWorkspaceException, set_configuration
...
class UnitTestGetClient(unittest.TestCase):
    @patch("santander_client.api_client.get_first_workspace_id_of_type", return_value=None)
    ...
    def test_get_client(self, mock_santander_client, mock_get_first_workspace_id):
        ...
        mock_get_first_workspace_id.assert_called_once_with(mock_client_instance, "PAYMENTS")
